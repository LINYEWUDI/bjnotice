            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li><a href="${pageContext.request.contextPath}/admin/coursewaremanager.do?actiontype=get" target="main"><span class="icon-caret-right"></span>公告管理</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin/coursewaremanager.do?actiontype=load" target="main"><span class="icon-caret-right"></span>发布公告</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin/cwtongji.jsp" target="main"><span class="icon-caret-right"></span>公告统计</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin/yingpianmanager.do?actiontype=get" target="main"><span class="icon-caret-right"></span>视频学习</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin/ypcatemanager.do?actiontype=get" target="main"><span class="icon-caret-right"></span>学习分类</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin/playrecordmanager.do?actiontype=get" target="main"><span class="icon-caret-right"></span>学习记录</a></li>
                ...
                <li >
                    <a href="#"><i class="fa fa-th-large"></i> <span class="nav-label">基础信息</span> <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li><a href="${pageContext.request.contextPath}/admin/studentmanager.do?actiontype=get" target="main"><span class="icon-caret-right"></span>用户管理</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin/banjimanager.do?actiontype=get" target="main"><span class="icon-caret-right"></span>班组管理</a></li>
                ...
                <li >
                    ...
                    <ul class="nav nav-second-level">
                        <li><a href="${pageContext.request.contextPath}/admin/accountinfo.jsp" target="main"><span class="icon-caret-right"></span>账户信息</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin/modifyinfo.jsp" target="main"><span class="icon-caret-right"></span>编辑账户</a></li>
           ...
           <div style="height:8%;" class="row border-bottom">
               <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                   ...
                   <ul class="nav navbar-top-links navbar-right">
                       <li>
                           <a target="_blank" href="${pageContext.request.contextPath}/e/login.jsp">首页</a>
                       </li>
                       <li>
