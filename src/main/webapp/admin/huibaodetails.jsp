...
<h2>
	                ...
	                <div class="description">
				        ...
				        <table cellpadding="0" cellspacing="1" class="grid" width="100%" >
											   ...
											   <td>
												   ${requestScope.huibao.title}
												</td>
											   </tr>
											   <tr>
											   <td align="right">汇报日期:</td>
											   <td>
												    <fmt:formatDate  value="${requestScope.huibao.hbdate}" pattern="yyyy-MM-dd" />
												</td>
											   </tr>
											   <tr>
											    <td align="right">文件地址:</td>
											   <td>
												    <li ><a href="${pageContext.request.contextPath}/plusin/download.jsp?filename=  ${requestScope.huibao.fileurl}"> 下载</a></li>
												</td>
											   </tr>
											   <tr>
											   <td width="10%" align="right" >汇报人:</td>
											   <td>
												   ${requestScope.huibao.hbren}
												</td>
											   </tr>
											   <tr>
											   <td width="10%" align="right" >姓名:</td>
											   <td>
												   ${requestScope.huibao.hbrname}
												</td>
											   </tr>
											 <tr>
											   <td align="right">汇报内容:</td>
											   <td colspan="3">
												${requestScope.huibao.dcontent}
											   </td>
											 </tr>
				        </table>
</body>
