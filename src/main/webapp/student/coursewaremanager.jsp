			 ...
			 <table cellspacing="0" width="100%">
				 ...
				 <tr>
					 <td>
						 ...
						 <input type="hidden" name="actorid" value="${sessionScope.student.id}"/>
						 <input type="hidden" name="forwardurl" value="/student/coursewaremanager.jsp"/>
	 ...
	 <table id="courseware" width="100%" border="0" cellspacing="0" cellpadding="0" class="ui-record-table">
		 ...
		 <tr>
			 ...
			 <td>
				 ...
				 <a class="orange-href"
					href="${pageContext.request.contextPath}/student/coursewaredetails.jsp?id=<%=temcourseware.getId()%>">查看</a>
			 </td>
		 </tr>
		 <%
				 }
