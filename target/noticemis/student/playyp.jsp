...
<script type="text/javascript">
         $(function(){
             $.ajax({
                 ...
                 url:"${pageContext.request.contextPath}/student/play",
                 method:'POST',
                 datatype:'JSON',
                 data:{
                     'mid':"${yingpian.id}",
                     ...
                     'accountname':"${sessionScope.student.stno}"
                 },
...
<div id="ap-player-box">
    <div id="ap-player-bar">
        ...
        <div class="ap-title">${requestScope.yingpian.title} <div id="ap-danmu-num">该教程已有 <span>0</span> 条吐槽!</div></div>
        <video id="ap-player">
