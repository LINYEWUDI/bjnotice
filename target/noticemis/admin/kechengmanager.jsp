...
<html>
	...
	<div class="search-title">
		...
		<div class="description">
			<a
				href="${pageContext.request.contextPath}/admin/kechengmanager.do?actiontype=load&forwardurl=/admin/kechengadd.jsp">新建科目信息</a>
		</div>
	</div>
	<!-- 搜索控件开始 -->
		...
		<tbody>
			...
			<tr>
				<td>&nbsp<input id="chk<%=temkecheng.getId()%>" class="check"
					name="ids" type="checkbox" value='<%=temkecheng.getId()%>'></td>
