...
<div id="div_background" >
    <div id="div_main">
        <div id="div_head"><p>记名传达管理<span>系统</span></p></div>
        <div id="div_content">
            ...
            <form id="loginForm" action="${pageContext.request.contextPath}/admin/login.do" method="post">
                ...
                <input type="text" class="form-control " placeholder="用户名" value="${username}" name="username" title="请输入用户名" />
                <input type="password" class="form-control " placeholder="密码" value="${password}" name="password" title="请输入密码" autocomplete="on">


                <div  class="form-group">
                    <div class="form-row">

                        <input name="usertype" value="1" type="radio" checked="checked"/>管理员
                        <input name="usertype" value="3" type="radio" />用户
...
<%--                </div>--%>
    ...
    <div id="div_foot">
        <span><a href="${pageContext.request.contextPath}/admin/facelogin.jsp">刷脸登录</a></span>
        <span> ⋅ </span>
