...
<html>
	...
	<div class="search-title">
		...
		<div class="description">
			<a
				href="${pageContext.request.contextPath}/admin/studentmanager.do?actiontype=load">新建用户</a>
		</div>
	</div>
	<!-- 搜索控件开始 -->
	<div class="search-options">
		<form id="searchForm"
			...
			<table cellspacing="0" width="100%">
				<tbody>
					<tr>
						<td>工号 <input name="stno" value="${stno}" class="input-txt"
