						        ...
						        <tr>
								  <td colspan="4">
								      ${errormsg}
											   ...
											   <td>
												   <input name="mingcheng" placeholder="名称" validate="{required:true,messages:{required:'请输入名称'}}" value="${requestScope.kecheng.mingcheng}" class="input-txt" type="text" id="txtMingcheng"  />
												</td>
											   </tr>
											   <tr>
											   <td align="right" >学分:</td>
											   <td>
												   <input name="xuefen" placeholder="学分" validate="{required:true,messages:{required:'请输入学分'}}" value="${requestScope.kecheng.xuefen}" class="input-txt" type="text" id="txtXuefen"  />
												</td>
											   </tr>
											   <tr>
											    <td align="right" >图片:</td>
											   <td>
												    <img id="imgTupian" width="200px" height="200px"  src="${pageContext.request.contextPath}${requestScope.kecheng.tupian}"/>
												    	<div>
